// uncontrolled form
// uncontrolled form - when we are not updating state value on every change that is uncontrolled.
//e.preventDefault() is used to prevent the default behavior of an event. stop the reloding the page
